  ...
  analyze(tiles: Tile[]): void {
    for (let i = 0; i < tiles.length; i++) {
      ...
      if (this.edges[TOP] === 0) {
        ...
        this.compareEdge(tile.edges[BOTTOM], this.edges[TOP]) &&
          this.up.push(tile.type);
      }
      ...
      if (this.edges[RIGHT] === 0) {
        ...
        this.compareEdge(tile.edges[LEFT], this.edges[RIGHT]) &&
          this.right.push(tile.type);
      }
      ...
      if (this.edges[BOTTOM] === 0) {
        ...
        this.compareEdge(tile.edges[TOP], this.edges[BOTTOM]) &&
          this.down.push(tile.type);
      }
      ...
      if (this.edges[LEFT] === 0) {
        ...
        this.compareEdge(tile.edges[RIGHT], this.edges[LEFT]) &&
          this.left.push(tile.type);
      }
    }
  }
}
